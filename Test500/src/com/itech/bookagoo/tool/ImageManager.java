...
/**
 * Created by Artem on 10.07.14.
 */
public class ImageManager {

    private static Vector<ImageView> sDownloaded = new Vector<ImageView>();
    ...
    public boolean findObject(ImageView object) {
        for (int i = 0; i < sDownloaded.size(); i++) {
            if (sDownloaded.elementAt(i).equals(object)) {
                return true;
            }
        }
        return false;
